...
// COLOR - ASSIGNMENT 
//----------------------------------------------------------------
import { Color, addPrototypeMethodsToColorClass } from './modules/color'
...
function processInputs(redInput: number, greenInput: number, blueInput: number, opacityInput: number) {
    try{
        const bodyContainerElement = document.querySelector(".body-container") as HTMLElement
        ...
        bodyContainerElement.style.backgroundColor = myColor.rbg();
    
        const rgbMethodString = myColor.rgb;
        console.log("rgbMethodString",rgbMethodString);
